...
def mainlist(item):
    ...
    itemlist.append(item.clone(
        ...
        content_type='items',
        description='Crea un lista con tus contenidos preferidos y compartela con tus familiares y amigos.'
    ))
...
def channel_info(item):
    ...
    #new_item.search = [d_categories[i['category']] for i in new_item.search]
